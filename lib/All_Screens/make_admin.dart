...
class MakeAdminInputPage extends StatefulWidget {
  const MakeAdminInputPage({super.key});

  @override
  _MakeAdminInputPageState createState() => _MakeAdminInputPageState();
}

class _MakeAdminInputPageState extends State<MakeAdminInputPage> {
  ...
  void makeAdmin() async {
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      await userDoc.reference.update({'is_admin': true});
